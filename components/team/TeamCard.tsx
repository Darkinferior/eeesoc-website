...
export const TeamCard: React.FC<TeamCardProps> = ({
  ...
  return (
    <>
      <Card className="sm:w-auto md:w-auto lg:w-auto justify-center ms-center transform hover:scale-105 transition-transform">
        ...
        <CardBody className="overflow-visible py-2 items-center text-center">
          ...
          <Reveal>
            {' '}
            <div className="mt-2 text-sm">{position}</div>
          </Reveal>
        </CardBody>
      </Card>
    </>
