        ...
        <Slide>
          ...
          >
            ...
            <p className='text-justify'>
              ...
              during these celebrations. It&apos;s more than just events;
              it&apos;s a platform where sponsors and collaborators get the
              spotlight they deserve. Join us in creating experiences that
              resonate, amplify, and leave a lasting impact!
            </p>
          </VerticalTimelineElement>
        </Slide>
        <Slide direction='right'>
